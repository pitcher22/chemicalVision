...
#ORG_EMAIL   = "@gmail.com"
FROM_EMAIL  = "chem.sensor.up@gmail.com"
FROM_PWD    = "RubberDuck1"
SMTP_SERVER = "imap.gmail.com"
SMTP_PORT   = 993

pickledEmail = open("FROM_EMAIL.pickle","wb")
pickle.dump(FROM_EMAIL, pickledEmail)
pickledEmail.close()
#pickling the email

pickledPassword = open("FROM_PWD.pickle","wb")
pickle.dump(FROM_PWD, pickledPassword)
pickledPassword.close()
#pickling the password
