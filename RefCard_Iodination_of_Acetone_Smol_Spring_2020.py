...
cv2.rectangle(ReferenceImage, (180,120), (400,1200), (255,255,0), -1) #left side of rectangle
cv2.rectangle(ReferenceImage, (180, 850), (900,1150), (255,255,0), -1) #bottom rectangle in digital view
cv2.rectangle(ReferenceImage, (700,120), (920,1200), (255,255,0), -1) #right side of rectangle
...
#magentaCircles
cv2.circle(ReferenceImage,(810,950), circler, (255,0,255), -1) 
cv2.circle(ReferenceImage,(810,220), circler, (255,0,255), -1) 

#yellowCircles
cv2.circle(ReferenceImage,(290,220), circler, (0,255,255), -1) 
cv2.circle(ReferenceImage,(290,950), circler, (0,255,255), -1) 
